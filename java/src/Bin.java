...
public class Bin {
	...
	public static final byte BIN_INTEGER_TYPE_Byte = 0x00 << 3; // 0000 0000
	public static final byte BIN_INTEGER_TYPE_Short = 0x01 << 3; // 000 1000
	public static final byte BIN_INTEGER_TYPE_Int = 0x02 << 3; // 0001 0000
	public static final byte BIN_INTEGER_TYPE_Long = 0x03 << 3; // 0001 1000
	...
	private static void do_pack(OutputStream out, Object obj, String charsetName) throws java.io.IOException {
		if (obj == null) {
			pack_null(out);
	...
	private static void pack_list(OutputStream out, List list, String charsetName) throws IOException {
	...
	private static void pack_string(OutputStream out, String s, String charsetName) throws IOException {
	...
	private static void pack_null(OutputStream out) throws IOException {
		out.write((byte) BIN_TYPE_NULL);
	}

	public static void pack_bool(OutputStream out, boolean v) throws IOException {
		out.write((byte) (v ? BIN_TYPE_BOOL : BIN_TYPE_BOOL_FALSE));
	}
